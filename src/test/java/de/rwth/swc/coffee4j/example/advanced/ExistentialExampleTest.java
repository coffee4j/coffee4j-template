...
public class ExistentialExampleTest {
    ...
    // test with valid and invalid test inputs
    @EnableGeneration(algorithms = { Ipog.class, IpogNeg.class })
    // only 1 test input for each error-constraint
    @ConfigureIpogNeg(constraintCheckerFactory = ExistentialMinimalForbiddenTuplesCheckerFactory.class)
    void test(
